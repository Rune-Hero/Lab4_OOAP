...
namespace Lab4
{
    class GiftOrder : OrderCalculator
    {
        private const double GiftWrapFee = 30.0;

        public GiftOrder(ICalcImplementor impl) : base(impl) { }
        ...
        public override double GetTotalPrice()
        {
            ...
            return Math.Round(subtotal + delivery + GiftWrapFee, 2);
        }

        public override void PrintOrder()
        {
            Console.WriteLine(new string('=', 50));
            Console.WriteLine("Замовлення з подарунковою упаковкою");
            ...
            Console.WriteLine($"{"Подарункова упаковка:",-28} {GiftWrapFee:F2} грн");
